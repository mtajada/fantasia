      ...
      >
        <div className="w-full max-w-md bg-white/90 rounded-3xl shadow-lg overflow-hidden">
          <div className="p-8 flex flex-col items-center">
            <div className="w-24 h-24 rounded-full bg-[#BB79D1]/20 flex items-center justify-center mb-6">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14 2.5L14 6.5C14 7.05 14.45 7.5 15 7.5L19 7.5" stroke="#BB79D1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M6 13.5V12.9C6 11.0297 6 10.0945 6.43597 9.4453C6.81947 8.87762 7.37762 8.45322 8.0453 8.21675C8.69945 8 9.51292 8 11.1398 8C11.6462 8 11.8994 8 12.1174 8.01666C12.3293 8.03261 12.5139 8.06577 12.6904 8.11391C12.86 8.16 13.0145 8.22462 13.3235 8.35385V8.35385C13.6195 8.47809 13.7675 8.54021 13.8789 8.63C13.9832 8.71405 14.0701 8.81649 14.1353 8.93149C14.2042 9.053 14.2457 9.19648 14.3287 9.48345L14.5 10.0001" stroke="#BB79D1" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M14.5 14.5L15.5 14.5" stroke="#BB79D1" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M9 18.5H12" stroke="#BB79D1" strokeWidth="1.5" strokeLinecap="round" />
